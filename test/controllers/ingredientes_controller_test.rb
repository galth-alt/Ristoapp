...
class IngredientesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ingrediente" do
    assert_difference("Ingrediente.count") do
      post ingredientes_url, params: { ingrediente: { giacenza: @ingrediente.giacenza, nome: @ingrediente.nome } }
    end
  ...
  test "should update ingrediente" do
    patch ingrediente_url(@ingrediente), params: { ingrediente: { giacenza: @ingrediente.giacenza, nome: @ingrediente.nome } }
