class IngredientesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @ingrediente.save
        format.html { redirect_to ingrediente_url(@ingrediente), notice: "Ingrediente was successfully created." }
  ...
  def update
    respond_to do |format|
      if @ingrediente.update(ingrediente_params)
        format.html { redirect_to ingrediente_url(@ingrediente), notice: "Ingrediente was successfully updated." }
  ...
  private
    ...
    def ingrediente_params
      params.require(:ingrediente).permit(:nome, :giacenza)
    end
end
